...
<div class="landing-top relative">
    ...
    <div class="hero-image h-[100vh] relative">
        ...
        <div class="hero-text uppercase text-white absolute bottom-48 text-[60px] max-[600px]:text-[50px] max-[600px]:text-[40px] left-16 max-[600px]:left-5 w-9/12 leading-[120px] flex flex-col">
