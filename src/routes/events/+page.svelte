    ...
    <div class="shipping-header my-12 justify-center items-center relative flex flex-col w-[90%]">
        ...
        <div class="main-event flex flex-row max-[600px]:flex-col gap-8">
            ...
            <div class="event-image h-[60vh]">
                <img src={headerImage} class="w-[820px] max-[600px]:w-[100%] h-[100%] object-contain" alt="main" />
            </div>
        </div>
    </div>
...
<div class="collections w-full flex flex-col items-center my-12">
    <div class="collections-header intro-details">
        <div class="intro-text-2 text-center text-[#df839c] text-[40px] max-[1415px]:text-[25px] font-medium font-['Raleway'] uppercase">OUR COLLECTIONS</div>
    </div>
    <IntersectionObserver element={collectionsBody} let:intersecting>
    <div class="grid grid-cols-6  max-[1415px]:grid-cols-3 gap-3 mt-8 h-[160px] max-[1415px]:h-[490px]" bind:this={collectionsBody}>
        {#if intersecting}
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/kitchenware.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Kitchenware</div>
        </div>
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/costumes.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Costumes</div>
        </div>
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/gardening.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Gardening</div>
        </div>
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/stationary.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Stationary</div>
        </div>
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/floral.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Floral Arrangement</div>
        </div>
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/decorations.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Decoration</div>
        </div>
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/cleaning.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Cleaning Supplies</div>
        </div>
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/household.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Household Supplies</div>
        </div>
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/babyproducts.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Baby Products</div>
        </div>
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/bakingsupplies.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Baking Supplies</div>
        </div>
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/fabrics.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Fabrics</div>
        </div>
        <div class="service w-[235px]  max-[1415px]:w-[120px] h-[77px]  max-[1415px]:h-[120px] bg-white rounded-xl shadow-lg flex flex-row  max-[1415px]:flex-col items-center p-5 gap-5  max-[1415px]:gap-3">
            <enhanced:img class="w-12 h-12 rounded-lg" src="$lib/assets/hardware.webp" alt=""/>
            <div class=" text-black text-[15px]  max-[1415px]:text-[12px] font-normal font-['Raleway'] uppercase tracking-wide">Hardware</div>
        </div>
        {/if}
...
<div class="parallax-container relative">
    <div class="object-cover w-screen bg-[#FFEDF2] h-[270vh] p-14 flex flex-col items-center">
        ...
        <div class="intro-details mt-10 max-[1415px]:mt-5 h-[65px]" bind:this={floralHeader}>
        ...
        <div class="intro-details h-[35px] max-[1415px]:h-[55px] mt-2 max-[1415px]:mt-3" bind:this={floralSubheader}>
        ...
        <div class="h-[600px] mt-20 max-[1415px]:w-[98vw]" bind:this={floralImage}>
            <IntersectionObserver element={floralImage} let:intersecting>
            {#if intersecting}
            <enhanced:img class="service w-[1300px] max-[1415px]:w-[98%] h-[600px] rounded-2xl object-cover" src="$lib/assets/eventsservice.webp" alt=""/>
            {/if}
            </IntersectionObserver>
        </div>
        
        <div class="grid grid-cols-3 max-[1415px]:grid-cols-2 mt-16 gap-10 max-[1415px]:gap-3 max-[1415px]:w-[95vw]" bind:this={floralCard}>
            <IntersectionObserver element={floralCard} let:intersecting>
                {#if intersecting}
                <enhanced:img class="service w-[400px] max-[1415px]:w-[600px] h-[360px] rounded-2xl object-cover" src="$lib/assets/flowerDisplay1.webp" alt=""/>
                <enhanced:img class="service w-[400px] max-[1415px]:w-[600px] h-[360px] rounded-2xl object-cover" src="$lib/assets/flowerDisplay2.webp" alt=""/>
                <enhanced:img class="service w-[400px] max-[1415px]:w-[600px] h-[360px] rounded-2xl object-cover" src="$lib/assets/flowerDisplay3.webp" alt=""/>
                <enhanced:img class="service w-[400px] max-[1415px]:w-[600px] h-[360px] rounded-2xl object-cover" src="$lib/assets/flowerDisplay4.webp" alt=""/>
                <enhanced:img class="service w-[400px] max-[1415px]:w-[600px] h-[360px] rounded-2xl object-cover" src="$lib/assets/flowerDisplay5.webp" alt=""/>
                <enhanced:img class="service w-[400px] max-[1415px]:w-[600px] h-[360px] rounded-2xl object-cover" src="$lib/assets/flowerDisplay6.webp" alt=""/>
                {/if}
            </IntersectionObserver>
...
<div class="introduction-section flex flex-col justify-center">
    <div class="careers-header mt-12 mb-12 max-[1415px]:mt-12 max-[1415px]:mb-3 justify-center relative flex h-[143px]" bind:this={careerHeader}>
        <IntersectionObserver element={careerHeader} let:intersecting>
            {#if intersecting}
                <div class="intro-details">
                    ...
                    {/if}
                    {#if innerWidth > 1415}
                        <div class="intro-text mt-8 text-center uppercase flex flex-col text-[67px] md:max-[1415px]:text-[24px] text-[#df839c]">
    ...
    <div class="parallax-container relative">
        ...
        <div class="services  flex flex-row justify-between items-center mb-10 absolute top-40 max-[1415px]:top-32 right-28">
...
<div class="subscribe-section flex flex-col items-center mt-20 mb-10">
    <div class="w-[95%] h-[380px] max-[1415px]:h-[580px] bg-[#df839c] rounded-xl p-10 flex flex-row max-[1415px]:flex-col items-center">
        {#if innerWidth <= 1415}
...
<div class="contact-section flex flex-col justify-center items-center h-[30vh] max-[1415px]:w-[100vw] mb-10">
    {#if y > 1250}
