...
<div class="introduction-section flex flex-col justify-center">
    <div class="career-header my-10 justify-center relative flex h-[150px] max-[1415px]:h-[200px]">
            <div class="intro-details">
                {#if innerWidth <= 600}
                <div class="intro-text mt-8 text-center uppercase flex flex-col text-[50px] max-[1415px]:text-[26px] text-[#4876B6] items-center">
                    <p>Choose the career that's</p>
                </div>
                <div class="intro-text mt-2 text-center uppercase flex flex-col text-[50px] max-[1415px]:text-[24px] text-[#4876B6] items-center">
                    <p>right for you!</p>
                </div>
                <div class="intro-subtext mt-4 text-center text-[#3D3938] text-[28px] max-[1415px]:text-[18px] raleway-light flex flex-col items-center">
                    <p>Choose from our list of available job</p>
                </div>
                <div class="intro-subtext mt-1 text-center text-[#3D3938] text-[28px] max-[1415px]:text-[18px] raleway-light flex flex-col items-center">
                    <p> opportunities below.</p>
                </div>
                {/if}
                {#if innerWidth > 600}
                <div class="intro-text mt-8 text-center uppercase flex flex-col text-[50px] max-[1415px]:text-[24px] text-[#4876B6] items-center">
                    <p>Choose the career that's right for you!</p>
                </div>
                <div class="intro-subtext text-center text-[#3D3938] text-[28px] max-[1415px]:text-[18px] raleway-light flex flex-col items-center">
    ...
    <div class="benefits text-justify text-[18px] raleway-light flex flex-col items-center">
        <p class="w-9/12  max-[1415px]:w-10/12">
